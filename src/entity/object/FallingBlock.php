...
class FallingBlock extends Entity{
	...
	protected function sendSpawnPacket(Player $player) : void{
		...
		//Legacy223BlockRuntimeIdMap::resolveNetworkBlockRuntimeId() doc comment. A wrong (modern-palette)
		//runtime ID here shows up as the falling block entity (sand/gravel/etc) rendering as an unrelated
		//block to a protocol 223 client.
		$this->getNetworkProperties()->setInt(EntityMetadataProperties::VARIANT, Legacy223BlockRuntimeIdMap::resolveNetworkBlockRuntimeId($typeConverter->getBlockTranslator(), $typeConverter->getProtocolId(), $this->block->getStateId()));
