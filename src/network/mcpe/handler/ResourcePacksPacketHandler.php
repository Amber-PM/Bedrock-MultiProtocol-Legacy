...
class ResourcePacksPacketHandler extends PacketHandler{
	...
	public function handleResourcePackClientResponse(ResourcePackClientResponsePacket $packet) : bool{
		switch($packet->status){
			...
			case ResourcePackClientResponsePacket::STATUS_HAVE_ALL_PACKS:
				...
				//skip on legacy clients: they have none of these pack versions locally and can't download them
	...
	public function handleResourcePackChunkRequest(ResourcePackChunkRequestPacket $packet) : bool{
		...
		if($this->session->getProtocolId() === ProtocolInfo::PROTOCOL_1_2_13){
			...
			$this->session->sendDataPacket(ResourcePackChunkDataPacket::create($packId, $packet->chunkIndex, $offset, $chunkData));
			return true;
		}
