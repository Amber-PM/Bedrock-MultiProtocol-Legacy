...
final class BlockIdMetaUpgrader{
	...
	/**
	 * Returns the full legacy string-ID/meta -> blockstate mapping table.
	 *
	 * @return BlockStateData[][]
	 * @phpstan-return array<string, array<int, BlockStateData>>
	 */
	...
	/**
	 * Returns the legacy numeric ID <-> string ID map used by this upgrader. Needed alongside getMappingTable() to
	 * recover the numeric ID for each entry, since the mapping table itself is keyed by string ID only.
	 */
	public function getLegacyNumericIdMap() : LegacyBlockIdToStringIdMap{
		return $this->legacyNumericIdMap;
	}
